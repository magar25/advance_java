...
public class RealCalculatorEngine implements ActionListener {

	RealCalculator parent; // a reference to the Calculator
	...
	RealCalculatorEngine(RealCalculator parent) {
		this.parent = parent;
	}
